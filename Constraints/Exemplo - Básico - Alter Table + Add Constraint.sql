...
ALTER TABLE Pai
Add   Constraint UQ_Pai Unique(RG_Pai)

ALTER TABLE Pai
Add   Constraint DF_Pai Default 0 FOR Sal_Pai

ALTER TABLE Pai
With Nocheck
Add  Constraint CH_Pai Check(Sal_Pai >=0)
...
ALTER TABLE Filho
Add  Constraint DF_Filho Default 'F' FOR Sexo_Filho

ALTER TABLE Filho
Add  Constraint CH_Filho Check(Sexo_Filho IN ('F','M'))

ALTER TABLE Filho
With Nocheck
Add  Constraint FK_Filho Foreign Key(Cod_Pai) References Pai(Cod_Pai)

INSERT Filho VALUES(4,1000,'Mercia Silva','F')
/* ****************************************** */
SELECT * FROM Pai
SELECT * FROM Filho
/* ****************************************** */
